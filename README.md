...
### Data Source- 
Created using the problem statement given in PDF file which is also replicated before each case study in a separate workbook. 
...
- Segregate the data given in problem statement in meaningful and related sub-blocks, so that there is an ease in calculation
- Calculated the necessary objectives using excel formulas and functions
- Made charts to visualize the outcomes for comparison
